...
<div class="explain-cover">
    ...
    <div class="explain-right">
        <img src="https://kirkim.github.io/assets/img/c/hash7.png" alt="hashfunction_test" width="100%" style="margin-top:3%">
...
<img src="https://kirkim.github.io/assets/img/c/hash8.png" alt="hash_string" width="100%" style="margin-top:3%">
...
<h2 style="color:#0e435c;">(2) 완전히 충돌을 없앨 수 있을까?</h2>
...
<h2 style="color:#0e435c;">(3) 충돌이 없어질 경우 코드변화(기본 예시)</h2>
...
<h2 style="color:#0e435c;">(3) 간단하고 나쁘지 않은 "65599"해시 함수</h2>
