...
* * *
<b> 다운로드링크에서 아나콘다 install 파일을 받은 뒤 설치를 진행합니다.
* `PATH`(경로)를 자동으로 설정해주는 옵션을 체크하고 설치하면 됩니다. (따로 `PATH`를 지정해줘도 되지만 번거롭기 때문입니다.)
...
* <b>Anaconda Navigator</b>를 실행한 뒤 <b>'Jupyter Notebook'</b>을 설치해 줍니다.
...
* <b>'주피터 노트북'</b>아이콘으로 직접 접속이 가능합니다.
<img src="https://kirkim.github.io/assets/img/python/jupyter/jupyter1.png" alt="jupyter_icon" width="100%">

* * *
* 아이콘을 클릭하면 터미널과 함께 자동으로 웹사이트가 열리게 됩니다.<b style="font-size:90%"> (localhost로 접속을 하는 것이기 때문에 **터미널**을 종료하면 웹사이트 접속도 끊기게 됩니다.)</b>
