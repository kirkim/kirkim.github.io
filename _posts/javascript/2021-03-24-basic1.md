...
이번 포스트는 **자바스크립트 **에 관한 내용입니다.

* * *
<h2>1️⃣ 자바스크립트 공부환경 만들기</h2>
<h3 style="color:#0e435c;">(1) html이용</h3>
...
* `index.html`파일의 경로를 직접 찾아서 들어가 실행해줍니다.(Chrome 환경을 이용)
...
* * *
<h3 style="color:#0e435c;">(2) Code Runner 확장 프로그램 이용</h3>
