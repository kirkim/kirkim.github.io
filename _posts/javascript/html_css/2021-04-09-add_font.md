...
<b>'language'</b>항목에서 <b>'korean'</b>을 선택하면 한글전용폰트를 볼 수 있습니다.<br />
...
<b>'Select this style'</b>를 눌러 원하는 스타일의 폰트를 추가해줍니다.<br />
...
하지만 자주 사용할 폰트이거나 코드를 깔끔하게 만들기 위해서 새로운 태그를 <b>&lt;<rd>style</rd>&gt;</b>태그 혹은 <rd>.css파일</rd>에 만들어서 사용하면 됩니다.
