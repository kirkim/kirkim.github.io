...
하지만 점점 생활 속에서 요구하는 AI기술수준이 높아짐에 따라 모델들을 감당하기 위한 비용이 증가할 수 밖에 없습니다.<br>
비용이 증가하는 요인은 다음과 같습니다.

- 모델의 크기(가중치)가 커져 계산량이 많아짐
- 모델사용량 증가

모델 크기 및 사용량 증가의 예시로는 다음과 같습니다.<br>
...
- Yolo모델중 Yolo3의 경우 80가지 물체를 감지할 수 있는데, 감지할 수 있는 물체의 가지수, 그만큼 가중치값이 증가하게 되어 모델의 크기가 점점 커지게 됩니다.<br>

이러한 비용 증가는 AI 기술의 발전을 저해할 수 있는 요인이 될 수 있습니다. 따라서 AI기술발전과 동시에, 비용 증가를 줄이기 위한 노력도 꾸준히 해야한다고 생각합니다.<br>
...
이처럼 단순히 하드웨어가 저렴할 뿐만 아니라 성능도 좋습니다.<br>
때문에 NPU가 AI기술이 발전함에 따라 점점 더 주목을 받고 있다고 생각합니다.
...
A11칩셋부터 A15칩셋까지의 변화를 살펴보면 CPU, GPU보다 **neural engine의 성능 및 코어 수의 증가**폭이 월등히 앞서고 있습니다.<br>
...
단순히 기능으로만 포함 관계를 따지자면 NPU ⊂ GPU ⊂ CPU 가 될 것 같습니다.<br>
...
- 학습보다는 추론에 특화됨<br>
  ...
  보일 수 도 있는 것 같습니다. 디바이스에는 큰 모델을 학습할만큼 충분한 GPU도 없습니다.
