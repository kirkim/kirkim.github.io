...
<div class="explain-cover">
    ...
    <div class="explain-right" style="padding-top:1%">
        <h4 align="middle" style="color:#0e435c;">&lt; test.java코드내용 &gt;</h4>
        <img src="https://kirkim.github.io/assets/img/java/7/compile8.png" alt="compile8">
    </div>
</div>
...
<img src="https://kirkim.github.io/assets/img/java/7/compile9.png" alt="compile9">
...
<img src="https://kirkim.github.io/assets/img/java/7/compile10.png" alt="compile10">
...
<img src="https://kirkim.github.io/assets/img/java/7/compile11.png" alt="compile11">
<div class="explain-cover">
    <div class="explain-left" style="padding-top:1%">
...
* `import`는 `.java`파일을 참고하지않습니다. 그렇기 때문에 참고할 `test.class`파일이 없고 `test.java`파일이 있더라도 다음과 같이 실행이 안됩니다.
