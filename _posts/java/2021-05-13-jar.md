...
<div class="explain-cover">
    <div class="explain-left" style="padding-top:1%">
        ▪️ 위에서 <rd>jar파일</rd>을 압축을 풀때 자동으로 생성됬던 <rd>MANIFEST.MF</rd>을 Manifest파일로 이용해도 됩니다.<br />
        ▪️ 자동으로 생성된 <rd>MANIFEST.MF</rd>파일에는 다음과 같이 jar파일에대한 정보가 적혀있었습니다.<br />
    </div>
    <div class="explain-right" style="padding-top:1%">
        <img src="https://kirkim.github.io/assets/img/java/compile/compile23.png" alt="compile2">
    </div>
</div>
