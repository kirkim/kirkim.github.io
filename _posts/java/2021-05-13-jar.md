...
<img src="https://kirkim.github.io/assets/img/java/compile/compile19.png" width="70%" alt="compile19">
...
* 사실 추가해줄 Manifest파일의 명은 아무거나 상관없지만 관습상 <rd>Manifest</rd>로 적어줍니다.
* 위에서 `jar파일`을 압축을 풀때 자동으로 생성됬던 `META-INF/MANIFEST.MF`을 Manifest파일로 이용해도 됩니다.
* 자동으로 생성된 `MANIFEST.MF`파일에는 다음과 같이 jar파일에대한 정보가 적혀있었습니다.
<kkr>
