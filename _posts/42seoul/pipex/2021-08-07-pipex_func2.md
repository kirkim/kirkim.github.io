...
* `execve()`함수는 <rd>exec계열함수</rd>입니다. **exec계열함수**의 종류는 여러가지가 있으며 그중에서 `execve()`함수는 유일한 <b style="color:blue">"system call함수"</b>입니다.
...
<div class="explain-cover">
    <div class="explain-left" style="padding-top:1%">
        <h4 align="middle" style="color:#0e435c;">&lt; 실행 전 &gt;</h4>
        <img src="https://kirkim.github.io/assets/img/pipex/pipex1.png" alt="before_file_list">
    </div>
    <div class="explain-right" style="padding-top:1%">
        <h4 align="middle" style="color:#0e435c;">&lt; 실행 후 &gt;</h4>
        <img src="https://kirkim.github.io/assets/img/pipex/pipex2.png" alt="after_file_list">
    </div>
</div>
...
* 하지만 `wc`와 같은 명령어는 <rd>"/bin"</rd>경로가 아닌 <rd>"usr/bin"</rd>에 위치하였습니다.
