...
* 자세한 파일의 코드는 <a href="https://pikuma.com/" target="blank"> &gt;&gt;PIKUMA</a>사이트의 <b>레이케스팅 강의</b>에서 볼 수 있습니다.
...
* 그렇기 때문에 <b>2D</b>지도와 동작을 먼저 구현하면 레이케스팅의 절반이상 과정이 끝난(?)거라고 할 수 있을 것 같습니다.

<h2 style="color:#0e435c;">(2) 2D지도</h2>

* <b>2D</b>지도는 <rd>이차원 배열</rd>을 이용하여 기본 틀을 만드는 것이 가독성면에서도 좋습니다.
* 요소로 `1(벽이 있을때)`와 `0(벽이 없을때)`을 가지게 됩니다.
* 각각의 벽은 <b>화면 해상도</b>를 고려해서 적당한 정사각형크기로 만들어주며 적절한 색을 입혀줍니다.<b style="font-size:90%">( p5.js 라이브러리를 이용하여 쉽게 구현이 가능합니다.)</b> 
<img src="https://kirkim.github.io/assets/img/cub3d/cub14.png" alt="raycasting_files" width="100%" style="margin-top:3%">