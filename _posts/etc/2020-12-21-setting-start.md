...
![setting03](/assets/setting03.png)

![그림1](assets/img/etc/setting![setting02](/assets/setting02_jp33fc40q.png)_start/2.png){: width="400" height="400}
위 그림과 같이 윈도우 아이콘에 설정 아이콘을 누릅니다.


![그림2](../../../..![setting02](/assets/setting02_333nk8kvw.png)/assets/img/etc/setting_start/2.png)
업데이트 보안을 클릭
