...
* 이처럼 `SDL.h`헤더를 가진 <re>SDL2</re>폴더도 있는 것도 확인도 했는데 vscode는 왜 못찾을까..

* * *
<h2>2️⃣ 해결법</h2>

* mac린이 입장에서는 homebrew로 파일을 설치하면 알아서 헤더파일경로를 추가해준다고 착각한 것이 문제였습니다. (어쩌면 있을수도있지만 찾지는 못했습니다)
...
* 다른 좋은 방법도 있겠지만 저처럼 삽질을 했을 사람들에게 도움이 되고자 포스트를 작성하게 됐습니다.